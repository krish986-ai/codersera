...
export const EventList: React.FC<EventListProps> = ({ events, onSelectEvent, onGoToLookup }) => {
  ...
  return (
    <div className="max-w-7xl mx-auto py-8 sm:py-12 px-4 sm:px-6 lg:px-8 space-y-16">
      ...
      {/* SECTION 5: EVENT PASS HOLDER SUPPORT & CHANNELS */}
      <section className="space-y-6 pt-4 border-t border-[#27272a]">
        <div>
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#121215] border border-cyan-500/30 text-cyan-300 text-xs font-mono mb-2">
            <MessageSquare className="w-3.5 h-3.5" />
            <span>ATTENDEE ASSISTANCE</span>
          </div>
          <h2 className="text-2xl sm:text-3xl font-bold text-white tracking-tight font-display">
            Pass Holder Channels & Support.
          </h2>
          <p className="text-slate-400 text-sm max-w-xl leading-relaxed mt-1">
            Need team members for Automate India 2026 or have queries about your pass? Connect directly with the organizing leads on WhatsApp.
          </p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          {/* Global Group */}
          <div className="p-6 rounded-2xl bg-[#121215] border border-[#27272a] hover:border-cyan-500/30 transition-all flex flex-col justify-between space-y-4">
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="text-xs text-slate-500 font-mono">Team Matchmaking</span>
              </div>
              <h3 className="text-lg font-bold text-white font-display">
                CodersEra Global Network
              </h3>
              <p className="text-slate-400 text-xs leading-relaxed mt-1">
                Connect with participants across institutes, find hackathon teammates, and get technical guidance.
              </p>
            </div>
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-emerald-500 hover:bg-emerald-400 text-slate-950 font-bold text-xs transition-all shadow-sm"
            >
              <MessageSquare className="w-4 h-4" />
              <span>Join Global WhatsApp</span>
          ...
          <div className="p-6 rounded-2xl bg-[#121215] border border-[#27272a] hover:border-cyan-500/30 transition-all flex flex-col justify-between space-y-4">
            <div>
              <div className="flex items-center justify-between mb-2">
                <span className="px-2.5 py-0.5 rounded text-[10px] font-mono font-bold bg-sky-950/80 text-sky-300 border border-sky-500/30">
                  VENUE CHAPTER
                </span>
                <span className="text-xs text-slate-500 font-mono">NIET Greater Noida</span>
              </div>
              <h3 className="text-lg font-bold text-white font-display">
                Automate India 2026 Desk
              </h3>
              <p className="text-slate-400 text-xs leading-relaxed mt-1">
                Direct venue coordination, gate pass help, physical badge collection, and schedule announcements.
              </p>
            </div>
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-cyan-500 hover:bg-cyan-400 text-slate-950 font-bold text-xs transition-all shadow-sm"
            >
              <MessageSquare className="w-4 h-4" />
              <span>Join NIET Chapter Desk</span>
              <ExternalLink className="w-3.5 h-3.5" />
            </a>
          </div>
        </div>
